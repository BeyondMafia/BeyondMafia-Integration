...
module.exports = class Player {
    ...
    parseCommand(message) {
        ...
        switch (cmd.name) {
            case "kick":
                ...
                var kickMeeting = this.getKickMeeting();
                if (kickMeeting) {
                    kickMeeting.vote(this, "Kick");
                    return;
                }
    ...
    kill(killType, killer, instant) {
        ...
        if (this.game.kickMeeting !== undefined) {
            this.game.kickMeeting.checkEnoughPlayersKicked();
        }
